...
const mockTasks: Task[] = [
  {
    id: '1',
    title: 'Revisar petição inicial Silva',
    description: 'Revisar minuta de petição inicial do caso Silva antes do protocolo. Verificar fundamentos jurídicos e documentos anexos.',
    priority: 'HIGH',
    status: 'IN_PROGRESS',
    assignedTo: 'Dr. Paulo',
    reviewer: 'Dra. Ana',
    ...
    tags: ['petição', 'revisão'],
    notes: 'Cliente solicitou urgência na revisão.',
    checklist: [
      { id: 'c1', text: 'Verificar dados do cliente', done: true },
      { id: 'c2', text: 'Conferir documentos anexos', done: true },
      { id: 'c3', text: 'Revisar fundamentação jurídica', done: false },
      { id: 'c4', text: 'Formatar conforme padrão', done: false },
    ],
    comments: [
      { id: 'cm1', author: 'Dra. Ana', avatar: '', content: 'Precisamos incluir jurisprudência recente do STJ sobre o tema.', createdAt: '2026-05-08T14:30:00Z' },
    ],
    subtasks: [
      { id: 'st1', title: 'Baixar jurisprudência atualizada', done: true, assignedTo: 'Dr. Paulo' },
      { id: 'st2', title: 'Anexar documentos digitalizados', done: false, assignedTo: 'Secretaria' },
    ],
    attachments: [
      { id: 'at1', name: 'minuta_peticao.docx', size: '245 KB', type: 'doc' },
      { id: 'at2', name: 'docs_cliente.zip', size: '1.2 MB', type: 'zip' },
    ],
    timeEntries: [
      { id: 'te1', startTime: '2026-05-09T09:00:00Z', endTime: '2026-05-09T11:30:00Z', description: 'Revisão inicial' },
    ],
    history: [
      { id: 'h1', field: 'status', oldValue: 'TODO', newValue: 'IN_PROGRESS', changedBy: 'Dr. Paulo', changedAt: '2026-05-07T08:00:00Z' },
    ],
    createdAt: '2026-05-05T10:00:00Z',
  },
  {
    id: '2',
    title: 'Protocolar recurso Oliveira',
    description: 'Protocolar recurso de apelação no tribunal. Prazo final hoje às 18h.',
    priority: 'URGENT',
    status: 'TODO',
    assignedTo: 'Dra. Maria',
    reviewer: 'Dr. Paulo',
    client: 'Maria Oliveira',
    caseNumber: '1234567-89.2023.8.26.0000',
    deadline: '2026-05-10T18:00:00Z',
    estimatedMinutes: 120,
    tags: ['recurso', 'protocolo', 'urgente'],
    notes: '',
    checklist: [
      { id: 'c5', text: 'Gerar guia de recolhimento', done: true },
      { id: 'c6', text: 'Assinar documento digital', done: false },
      { id: 'c7', text: 'Protocolar no sistema', done: false },
    ],
    comments: [],
    subtasks: [],
    attachments: [
      { id: 'at3', name: 'recurso_apelacao.pdf', size: '890 KB', type: 'pdf' },
    ],
    timeEntries: [],
    history: [],
  ...
  {
    id: '3',
    title: 'Organizar documentos novos clientes',
    description: 'Organizar pastas digitais dos novos clientes do mês.',
    priority: 'LOW',
    status: 'COMPLETED',
    ...
    notes: '',
    checklist: [
      { id: 'c8', text: 'Criar pastas no drive', done: true },
      { id: 'c9', text: 'Digitalizar documentos', done: true },
      { id: 'c10', text: 'Classificar por caso', done: true },
    ],
    comments: [],
    subtasks: [],
    attachments: [],
    timeEntries: [],
    history: [
      { id: 'h2', field: 'status', oldValue: 'IN_PROGRESS', newValue: 'COMPLETED', changedBy: 'Secretaria', changedAt: '2026-05-08T16:30:00Z' },
    ],
    createdAt: '2026-05-01T08:00:00Z',
  },
  {
    id: '4',
    title: 'Conferir contrato de honorários',
    description: 'Revisar e aprovar contrato de honorários para novo cliente corporativo.',
    priority: 'MEDIUM',
    status: 'IN_REVIEW',
    assignedTo: 'Dr. Paulo',
    reviewer: 'Dra. Ana',
    ...
    notes: '',
    checklist: [
      { id: 'c11', text: 'Verificar cláusulas contratuais', done: true },
      { id: 'c12', text: 'Aprovar valor dos honorários', done: false },
    ],
    comments: [
      { id: 'cm2', author: 'Dra. Ana', avatar: '', content: 'O valor proposto está dentro da tabela de honorários.', createdAt: '2026-05-09T10:00:00Z' },
    ],
    subtasks: [],
    attachments: [
      { id: 'at4', name: 'contrato_honorarios_v2.docx', size: '312 KB', type: 'doc' },
    ],
    timeEntries: [],
    history: [
      { id: 'h3', field: 'status', oldValue: 'TODO', newValue: 'IN_REVIEW', changedBy: 'Dra. Ana', changedAt: '2026-05-09T10:00:00Z' },
    ],
  ...
  },
  {
    ...
    description: 'Enviar notificação extrajudicial ao cliente sobre parcela em atraso.',
    priority: 'HIGH',
    status: 'TODO',
    assignedTo: 'Secretaria',
    reviewer: '',
    client: 'João Pereira',
    caseNumber: '9876543-21.2022.8.19.0001',
    deadline: '2026-05-12T17:00:00Z',
    estimatedMinutes: 45,
    tags: ['cobrança'],
    notes: 'Terceira tentativa de contato.',
    checklist: [
      { id: 'c13', text: 'Gerar boleto atualizado', done: false },
      { id: 'c14', text: 'Enviar e-mail de cobrança', done: false },
      { id: 'c15', text: 'Registrar no sistema', done: false },
    ],
    comments: [],
    subtasks: [],
    attachments: [],
  ...
  },
  {
    ...
    description: 'Elaborar contestação em ação trabalhista. Prazo exíguo.',
    priority: 'CRITICAL',
    status: 'IN_PROGRESS',
    assignedTo: 'Dra. Maria',
    reviewer: 'Dr. Paulo',
    client: 'Empresa XYZ',
    caseNumber: '5555666-77.2024.5.01.0001',
    deadline: '2026-05-14T23:59:00Z',
    estimatedMinutes: 480,
    tags: ['trabalhista', 'contestação', 'urgente'],
    notes: 'Prazo improrrogável. Prioridade máxima.',
    checklist: [
      { id: 'c16', text: 'Analisar petição inicial', done: true },
      { id: 'c17', text: 'Levantar documentos do cliente', done: true },
      { id: 'c18', text: 'Redigir contestação', done: false },
      { id: 'c19', text: 'Revisar com sócio', done: false },
      { id: 'c20', text: 'Protocolar', done: false },
    ],
    comments: [
      { id: 'cm3', author: 'Dr. Paulo', avatar: '', content: 'Precisamos dos comprovantes de pagamento das verbas rescisórias.', createdAt: '2026-05-08T09:15:00Z' },
      { id: 'cm4', author: 'Dra. Maria', avatar: '', content: 'Cliente já enviou os documentos solicitados.', createdAt: '2026-05-09T14:00:00Z' },
    ],
    subtasks: [
      { id: 'st3', title: 'Solicitar documentos ao cliente', done: true, assignedTo: 'Dra. Maria' },
      { id: 'st4', title: 'Pesquisar jurisprudência', done: false, assignedTo: 'Dr. Paulo' },
    ],
    attachments: [
      { id: 'at5', name: 'peticao_inicial_xyz.pdf', size: '560 KB', type: 'pdf' },
      { id: 'at6', name: 'documentos_cliente.zip', size: '3.4 MB', type: 'zip' },
    ],
    timeEntries: [
      { id: 'te2', startTime: '2026-05-08T08:00:00Z', endTime: '2026-05-08T12:00:00Z', description: 'Análise inicial' },
      { id: 'te3', startTime: '2026-05-09T08:00:00Z', description: 'Redação da contestação' },
    ],
    history: [
      { id: 'h4', field: 'priority', oldValue: 'HIGH', newValue: 'CRITICAL', changedBy: 'Dr. Paulo', changedAt: '2026-05-07T15:00:00Z' },
      { id: 'h5', field: 'status', oldValue: 'TODO', newValue: 'IN_PROGRESS', changedBy: 'Dra. Maria', changedAt: '2026-05-08T08:00:00Z' },
    ],
    createdAt: '2026-05-02T07:00:00Z',
  },
  {
    id: '7',
    title: 'Responder esclarecimentos cliente',
    description: 'Responder dúvidas do cliente sobre andamento processual.',
    priority: 'MEDIUM',
    status: 'AWAITING_CLIENT',
    assignedTo: 'Dr. Paulo',
    reviewer: '',
    client: 'Roberto Almeida',
    caseNumber: '1111222-33.2021.8.26.0100',
    deadline: '2026-05-13T17:00:00Z',
    estimatedMinutes: 30,
    tags: ['atendimento', 'cliente'],
    notes: 'Cliente aguarda retorno sobre audiência.',
    checklist: [
      { id: 'c21', text: 'Verificar andamento processual', done: true },
      { id: 'c22', text: 'Preparar relatório', done: false },
    ],
    comments: [
      { id: 'cm5', author: 'Roberto Almeida', avatar: '', content: 'Bom dia, gostaria de saber se já há data para audiência.', createdAt: '2026-05-07T11:00:00Z' },
    ],
    subtasks: [],
    attachments: [],
    timeEntries: [],
  ...
  },
  {
    ...
    description: 'Atualizar planilha geral de prazos do escritório com novos prazos do mês.',
    priority: 'LOW',
    status: 'TODO',
    assignedTo: 'Secretaria',
    reviewer: '',
    ...
    notes: '',
    checklist: [
      { id: 'c23', text: 'Coletar prazos com advogados', done: false },
      { id: 'c24', text: 'Inserir na planilha', done: false },
    ],
    comments: [],
    subtasks: [],
    attachments: [],
  ...
  },
  {
    ...
    description: 'Elaborar parecer sobre viabilidade de ação indenizatória.',
    priority: 'MEDIUM',
    status: 'AWAITING_DOCUMENT',
    assignedTo: 'Dra. Maria',
    reviewer: 'Dr. Paulo',
    client: 'Fernanda Costa',
    caseNumber: '3333444-55.2023.8.26.0200',
    deadline: '2026-05-22T17:00:00Z',
    estimatedMinutes: 300,
    tags: ['parecer', 'indenização'],
    notes: 'Aguardando documentos complementares do cliente.',
    checklist: [
      { id: 'c25', text: 'Analisar documentação recebida', done: false },
      { id: 'c26', text: 'Pesquisar jurisprudência', done: false },
      { id: 'c27', text: 'Redigir parecer', done: false },
    ],
    comments: [
      { id: 'cm6', author: 'Dra. Maria', avatar: '', content: 'Cliente prometeu enviar documentos até sexta.', createdAt: '2026-05-09T16:00:00Z' },
    ],
    subtasks: [],
    attachments: [],
    timeEntries: [],
  ...
  {
    id: '10',
    title: 'Acompanhar audiência virtual',
    description: 'Acompanhar audiência de conciliação virtual e fazer anotações.',
    priority: 'HIGH',
    ...
    notes: 'Link da sala virtual será enviado por e-mail.',
    checklist: [
      { id: 'c28', text: 'Confirmar horário com cliente', done: true },
      { id: 'c29', text: 'Preparar resumo do caso', done: false },
    ],
    comments: [],
    subtasks: [],
    attachments: [],
    timeEntries: [],
    history: [
      { id: 'h6', field: 'status', oldValue: 'TODO', newValue: 'AWAITING_LAWYER', changedBy: 'Dr. Paulo', changedAt: '2026-05-09T07:30:00Z' },
    ],
    createdAt: '2026-05-05T15:00:00Z',
  },
  {
    id: '11',
    title: 'Formatar parecer para envio',
    description: 'Formatar parecer jurídico no template do escritório e enviar ao cliente.',
    priority: 'LOW',
    status: 'COMPLETED',
    assignedTo: 'Secretaria',
    reviewer: '',
    ...
    estimatedMinutes: 45,
    tags: ['formatação', 'parecer'],
    notes: '',
    checklist: [
      { id: 'c30', text: 'Aplicar template', done: true },
      { id: 'c31', text: 'Converter para PDF', done: true },
      { id: 'c32', text: 'Enviar por e-mail', done: true },
    ],
    comments: [],
    subtasks: [],
    attachments: [],
    timeEntries: [
      { id: 'te4', startTime: '2026-05-09T09:00:00Z', endTime: '2026-05-09T09:45:00Z', description: 'Formatação e envio' },
    ],
    history: [
      { id: 'h7', field: 'status', oldValue: 'TODO', newValue: 'COMPLETED', changedBy: 'Secretaria', changedAt: '2026-05-09T09:45:00Z' },
    ],
    createdAt: '2026-05-05T08:00:00Z',
  },
  {
    id: '12',
    title: 'Reunião estratégica semanal',
    description: 'Reunião de alinhamento da equipe sobre casos em andamento.',
    priority: 'MEDIUM',
    status: 'IN_PROGRESS',
    assignedTo: 'Equipe',
    reviewer: '',
    ...
    estimatedMinutes: 60,
    tags: ['reunião', 'interno'],
    notes: 'Pauta: revisão de casos críticos e distribuição de tarefas.',
    checklist: [
      { id: 'c33', text: 'Preparar pauta', done: true },
      { id: 'c34', text: 'Revisar indicadores', done: false },
    ],
    comments: [],
    subtasks: [],
    attachments: [],
