        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4">
              {NAV_ITEMS.map(item => (
                <li key={item.href}>
                  <a href={item.href} className="text-white hover:text-[#d4af37] transition-colors text-sm">{item.label}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="#atuacao" className="text-white hover:text-[#d4af37] transition-colors text-sm">Rescisão Indireta</a></li>
              <li><a href="#atuacao" className="text-white hover:text-[#d4af37] transition-colors text-sm">Horas Extras</a></li>
              <li><a href="#atuacao" className="text-white hover:text-[#d4af37] transition-colors text-sm">Dano Moral</a></li>
              <li><a href="#atuacao" className="text-white hover:text-[#d4af37] transition-colors text-sm">Acidente de Trabalho</a></li>
            </ul>
          </div>

          <div>
            <h4 className="text-white font-bold uppercase tracking-widest text-xs mb-8">Informações</h4>
            <p className="text-white text-sm mb-4">OAB/SP: 000.000</p>
            <p className="text-white text-sm mb-4">CNPJ: 00.000.000/0001-00</p>
